...
Version `1.0.1` keeps that stable API while refreshing the build chain and resolving the known esbuild development-server advisory in the release toolchain.
